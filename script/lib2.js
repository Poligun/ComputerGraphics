...
function gl_init(gl, vertexShader, fragmentShader) {
   ...
   ['uTime','uCursor', 'uBlinn', 'uBoolean', 'uReflection'].forEach(function(name) {
...
function gl_update(gl) {
   ...
   gl.uniform1i(gl.uBlinn, document.getElementById('using_phong').checked);
   gl.uniform1i(gl.uBoolean, document.getElementById('using_boolean').checked);
